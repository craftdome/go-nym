...
func (c *Client) GetNodeAnnotation(ctx context.Context, nodeID models.NodeID) (NodeAnnotation, error) {
...
func (c *Client) GetNodePerformance(ctx context.Context, nodeID models.NodeID) (NodePerformance, error) {
